...
def cloneRepo ():
    ...
    label12 = tk.Label(root, text='Clone Repo', bg = '#e7e7e7', fg = '#676767')
    label12.config(font=('calibri', 40))
    canvas2.create_window(150, 100, window=label12)
...
def makeRepo ():
    ...
    label10.config(font=('calibri', 20))
    canvas2.create_window(125, 250, window=label10)
    label12 = tk.Label(root, text='Make Repo', bg = '#e7e7e7', fg = '#676767')
    label12.config(font=('calibri', 40))
    canvas2.create_window(150, 100, window=label12)
    entry3 = tk.Entry (root) 
    canvas2.create_window(300, 250, window=entry3)
...
def addFile ():
    canvas2 = tk.Canvas(root, width = 500, height = 500, bg = '#e7e7e7')
    canvas1.create_window(500, 400, window=canvas2)
    label12 = tk.Label(root, text='Add File', bg = '#e7e7e7', fg = '#676767')
    label12.config(font=('calibri', 40))
    canvas2.create_window(150, 100, window=label12)
    entry3 = tk.Entry (root) 
    canvas2.create_window(300, 250, window=entry3)
...
def status ():
    canvas2 = tk.Canvas(root, width = 500, height = 500, bg = '#e7e7e7')
    canvas1.create_window(500, 400, window=canvas2)
    label12 = tk.Label(root, text='Repo Status', bg = '#e7e7e7', fg = '#676767')
    label12.config(font=('calibri', 40))
    canvas2.create_window(150, 100, window=label12)
    label10 = tk.Label(root, text='Repo Directory :', bg = '#e7e7e7', fg = '#676767')
    label10.config(font=('calibri', 20))
...
def commit ():
    canvas2 = tk.Canvas(root, width = 500, height = 500, bg = '#e7e7e7')
    canvas1.create_window(500, 400, window=canvas2)
    label12 = tk.Label(root, text='Commit', bg = '#e7e7e7', fg = '#676767')
    label12.config(font=('calibri', 40))
    canvas2.create_window(150, 100, window=label12)
    label10 = tk.Label(root, text='Repo Directory :', bg = '#e7e7e7', fg = '#676767')
    label10.config(font=('calibri', 20))
...
def remove ():
    canvas2 = tk.Canvas(root, width = 500, height = 500, bg = '#e7e7e7')
    canvas1.create_window(500, 400, window=canvas2)
    label12 = tk.Label(root, text='Remove File', bg = '#e7e7e7', fg = '#676767')
    label12.config(font=('calibri', 40))
    canvas2.create_window(150, 100, window=label12)
    label10 = tk.Label(root, text='Repo Directory :', bg = '#e7e7e7', fg = '#676767')
    label10.config(font=('calibri', 20))
...
def history ():
    canvas2 = tk.Canvas(root, width = 500, height = 500, bg = '#e7e7e7')
    canvas1.create_window(500, 400, window=canvas2)
    label12 = tk.Label(root, text='Repo History', bg = '#e7e7e7', fg = '#676767')
    label12.config(font=('calibri', 40))
    canvas2.create_window(150, 100, window=label12)
    label10 = tk.Label(root, text='Repo Directory :', bg = '#e7e7e7', fg = '#676767')
    label10.config(font=('calibri', 20))
...
def login ():
    canvas2 = tk.Canvas(root, width = 500, height = 500, bg = '#e7e7e7')
    canvas1.create_window(500, 400, window=canvas2)
    label12 = tk.Label(root, text='Login', bg = '#e7e7e7', fg = '#676767')
    label12.config(font=('calibri', 40))
    canvas2.create_window(150, 100, window=label12)
